...
# Drop NAs from observed mLWP values
X_Obsv = X.dropna()
...
# Scatterplot with linear predicted vs observed mLWP values
pred_plot = sns.scatterplot(x = X_Comp.Pred, y = X_Comp.mLWP, alpha = 0.5, s = 50, ax = ax2)
...
pred_plot.set(xlabel = "Predicted value of mLWP", ylabel = "Observed value of mLWP",
