...
![](https://pandas-profiling.ydata.ai/docs/assets/logo_header.png){fig-align="left"}
...
sns.stripplot(data = data, x = "Outcome1", y = "BMI", alpha = 0.5, hue = "Outcome1", legend = False, s = 15)
```
...
AgeStrip = sns.stripplot(data = data, x = "Age_group", y = "BMI", alpha = 0.5, hue = "Age_group", legend = False, s = 15)
